...
public class SinifService {
    ...
    public static void save(){
        try{
            Lab lab1 = new Lab("B Blok Giriş Kat 20'nolu Laboratuvar");
            Dolap dolap1 = new Dolap("11");
            Okul okul1 = new Okul("Ahmet Yesevi İlköğretim");

            Sinif sinif1 = new Sinif("B Blok 2.Kat 15 nolu Sınıf", lab1, Arrays.asList(dolap1), okul1);
